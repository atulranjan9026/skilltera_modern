...
import { User, Building2, ChevronDown, Mail } from "lucide-react";
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
        ...
        {showContactModal && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl border border-slate-200 p-6 w-80 relative shadow-lg">
              <button
              ...
              <p className="text-xs text-slate-500 mb-4 leading-relaxed">
                Reach out to the Skilltera team and we'll get your company set
                up.
              </p>

              <div className="bg-slate-50 rounded-lg px-3 py-2.5 flex items-center gap-2 mb-4">
                <Mail size={14} className="text-indigo-500 shrink-0" />
                <a
                  href="mailto:service@skilltera.info"
                  className="text-xs text-indigo-600 font-medium"
                >
                  service@skilltera.info
                </a>
              </div>
